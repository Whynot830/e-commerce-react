...
const Footer = () => {
    return (
        <footer className="flex justify-between bg-black/30">
            <div className="container flex py-3 min-h-14 max-w-screen-2xl justify-center sm:justify-between gap-4 sm:items-center">
                <p className="flex items-center text-sm font-medium tracking-wide text-wrap">
                    <CopyrightIcon size={14} className="mr-1" /> FS 2024 &mdash; Все права защищены
                </p>
